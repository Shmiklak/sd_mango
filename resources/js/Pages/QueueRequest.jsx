                                ...
                                <div className="queue-request-beatmap mb-3">
                                    <div className="beatmap-cover">
                                        <img
                                            ...
                                            onError={(e) =>
                                                setCover(
                                                    "/static/assets/images/bg_error.png",
                                                )
                                            }
                                    ...
                                    <div className="beatmap-text">
                                        <div className="text-center mb-3">
                                            <audio controls={true}>
                                                <source
                                                    src={`https://b.ppy.sh/preview/${beatmap.beatmapset_id}.mp3`}
                                                />
                                            </audio>
                                        </div>
                            ...
                            <div className="col-lg-6">
                                <div className="queue-request-nominators-info mb-5">
                                    ...
                                    {auth.user.elevated_access ? (
                                        <NominatorResponseForm
                                            auth={auth}
                                            responses={beatmap.responses}
