        ...
        <div className="grid">
            <div className="beatmap">
                <div className="beatmap-cover">
                    ...
                    <Button
                        variant="accent"
                        className="beatmap-view-btn"
                        asChild
                    >
                        <Link href={route("queue_request", props.beatmap.id)}>
                ...
                <div className="beatmap-text">
                    <div className="text-center mb-3">
                        <audio controls={true}>
                            <source
                                src={`https://b.ppy.sh/preview/${props.beatmap.beatmapset_id}.mp3`}
                            />
                        </audio>
                    </div>
